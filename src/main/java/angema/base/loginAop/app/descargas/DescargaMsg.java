...
public class DescargaMsg {
    ...
    // FONT PRIMARY ############################################################################################################
    public static final String FONT_PRIMARY_SUMMARY = "@PathVariable String cuitSocio, @Return byte[]";
    ...
    // FONT SECONDARY  ############################################################################################################
    public static final String FONT_SECONDARY_SUMMARY = "@PathVariable String cuitSocio, @Return byte[]";
